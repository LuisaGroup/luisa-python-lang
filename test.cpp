...
auto sqr_B83A0C27(lc_float __arg_0) -> lc_float {
    // BasicBlock Begin None
    auto v1 = __arg_0 * __arg_0;
    return v1;
    // BasicBlock End None
}
auto foo_BACA515A(lc_float __arg_0,lc_float __arg_1) -> lc_float {
    // BasicBlock Begin None
    auto v1 = __arg_0 < __arg_1;
    if (v1) {
        // BasicBlock Begin None
        auto v2 = __arg_0 + __arg_1;
        auto v3 = sqr_B83A0C27(v2);
        return v3;
        // BasicBlock End None
    }
    else {
        // BasicBlock Begin None
        auto v4 = __arg_0 - __arg_1;
        return v4;
        // BasicBlock End None
    }
    // BasicBlock End None
